...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostoksen_paatyttya_kutsutaan_oikeita_metodeita(self):
    ...
    def test_ostoksen_paatyttya_kutsutaan_oikeita_metodeita_kun_lisatty_kaksi_eri_tuotetta(self):
    ...
    def test_ostoksen_paatyttya_kutsutaan_oikeita_metodeita_kun_lisatty_kaksi_samaa_tuotetta(self):
    ...
    def test_ostoksen_paatyttya_kutsutaan_oikeita_metodeita_kun_lisatty_kaksi_eri_tuotetta_joista_toisella_ei_ole_saldoa(self):
    ...
    def test_tuotteen_poisto_korista_toimii(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
